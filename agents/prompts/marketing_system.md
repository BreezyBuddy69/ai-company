...
NOTE: this agent is a v1 stub. It does not yet have web/SEO tooling or
access to the `products` table — only `write_memory`. Use it to record a
marketing plan as an experiment memory until real tooling (Phase 2) lands.

Call `finish` once you've recorded the plan.
